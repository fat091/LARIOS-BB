...
public class FumadoresPanel extends JPanel implements Reseteable, Demoable, SyncAware {
    ...
    static class Mesa extends JPanel {
        ...
        protected void paintComponent(Graphics g) { 
            ...
            // Panel de recursos con mejor diseño
