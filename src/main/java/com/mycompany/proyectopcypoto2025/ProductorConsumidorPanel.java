...
public class ProductorConsumidorPanel extends JPanel implements Reseteable, Demoable, SyncAware {
    ...
    static class Tanque extends JPanel {
        ...
        public synchronized void setProduciendo(boolean p) { produciendo = p; }
        public synchronized void setConsumiendo(boolean c) { consumiendo = c; }
        ...
        private void dibujarTanqueConEfectos(Graphics2D g2, int x, int y, int W, int H) {
            ...
            int nl;
            synchronized(this) { nl = this.nivel; }
            
            // Agua con efecto de onda
            if(nl > 0) {
                int waterH = nl * H / 20;
